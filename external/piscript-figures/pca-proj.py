...
Label(r'${\boldsymbol u}_1$', e1, alignment="lt", offset=[dx,-2]).draw()
Label(r'${\boldsymbol u}_2$', e2, alignment="rb", offset=[-dx,5]).draw()
Label(r'${\boldsymbol x}$', w, alignment="lt", offset=[dx+3,0]).draw()
Label(r'$\widehat{\boldsymbol x}$', proj, alignment="rt",
