...
Label(r"${\boldsymbol v}$", v, offset=[4,-4], alignment="lt").draw()
Label(r"${\boldsymbol w}_1$", w1, offset=[-4,4], alignment="rb").draw()
Label(r"${\boldsymbol w}_2$", w2, offset=[4,4], alignment="lb").draw()
