...
Label(r'${\boldsymbol n}$', [3,4], alignment='lt', offset=[3,-3]).draw()
Label(r'${\boldsymbol p}$', [1.5,1.5], alignment='rb', offset=[-1,1]).draw()
Label(r'${\boldsymbol x}$', [4,1], alignment='lb', offset=[3,3]).draw()
