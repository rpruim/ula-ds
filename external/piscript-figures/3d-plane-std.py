...
height = 150
sc=1
init3d("3d-plane-std", int(sc*width)+10, int(sc*height)+10)
beginpage()
...
e1 = smult(0.5, tofig([1,0,0]))
e2 = smult(0.5, tofig([0,1,0]))
...
Label(r'${\boldsymbol e}_1$', e1, alignment="rb", offset=[-dx,dx]).draw()
Label(r'${\boldsymbol e}_2$', e2, alignment="rb", offset=[-dx,dx]).draw()
