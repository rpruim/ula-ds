...
Label(r"${\boldsymbol v}$", v, offset=[5,0], alignment="lc").draw()
Label(r"$C{\boldsymbol v}$", w, offset=[-5,0], alignment="rc").draw()
...
Label(r"${\boldsymbol v}$", Pv, offset=[5,0], alignment="lc").draw()
Label(r"$A{\boldsymbol v}$", APv, offset=[-5,0], alignment="rc").draw()
