...
sc = 1.2
Label(r"$\widehat{\boldsymbol b}$", bhat, alignment="lt", scale=sc,
      offset=[2,-2]).draw()
Label(r"${\boldsymbol b}^\perp$", bperp, alignment="rt", scale=sc,
      offset=[-1,0]).draw()
Label(r"${\boldsymbol b}$", w, alignment="rb", scale=sc,
      offset=[-2,2]).draw()
