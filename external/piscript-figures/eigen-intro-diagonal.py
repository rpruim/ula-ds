...
Label(r"${\boldsymbol e}_1$", [1,0], alignment="lt", offset=[3,-3]).draw()
Label(r"${\boldsymbol e}_2$", [0,1], alignment="rb", offset=[-3,3]).draw()
...
Label(r"$3{\boldsymbol e}_1$", basis[0], alignment="lb", offset=[3,3]).draw()
Label(r"$-{\boldsymbol e}_2$", basis[1], alignment="rt", offset=[-3,-3]).draw()
