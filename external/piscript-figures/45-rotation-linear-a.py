...
drawvector(cu, blue)
drawvector(u, gray)
Label(r"${\boldsymbol v}$", u, offset=[3,-3], alignment="lt").draw()
Label(r"$c{\boldsymbol v}$", cu, offset=[3,-3], alignment="lt").draw()
...
drawvector(Tcu,blue)
drawvector(Tu,gray)
Label(r"$T({\boldsymbol v})$", Tu, offset=[3,-3], alignment="lt").draw()
Label(r"$T(c{\boldsymbol v})$", Tcu, offset=[3,-3], alignment="lt").draw()
