...
Label(r'${\boldsymbol v}$', v, offset=[3,3], alignment='lb').draw()
Label(r'${\boldsymbol w}$', w, offset=[3,3], alignment='lb').draw()
Label(r'${\boldsymbol u}$', u, offset=[3,3], alignment='lb').draw()
