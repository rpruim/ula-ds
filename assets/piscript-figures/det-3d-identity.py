...
width=150
height=150
init3d("det-3d-identity", width, height)
beginpage()
...
for v in basis:
    drawvec(v, [0.2]*3)
'''
Label(r"${\boldsymbol v}_1$", v1, alignment="rc", offset=[-6,0]).draw()
Label(r"${\boldsymbol v}_2$", v2, alignment="lb", offset=[3,3]).draw()
Label(r"${\boldsymbol v}_3$", v3, alignment="rb", offset=[-4,4]).draw()
