...
v = [1,2]
Label(r"${\boldsymbol v}$", v, alignment="lt", offset=[3,-3]).draw()
Label(r"$2{\boldsymbol v}$", smult(2,v), alignment="lt", offset=[3,-3]).draw()
Label(r"$-{\boldsymbol v}$", smult(-1,v), alignment="lt", offset=[3,-3]).draw()
