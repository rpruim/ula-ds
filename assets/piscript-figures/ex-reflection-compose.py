...
drawvector(u)
Label(r"${\boldsymbol x}$", u, alignment="rt", offset=[-5,-5]).draw()
grestore()
...
drawvector(u)
Label(r"$R({\boldsymbol x})$", u, alignment="lb", offset=[3,3]).draw()
grestore()
...
drawvector(Tu)
Label(r"$S(R({\boldsymbol x}))$", Tu, alignment="lb", offset=[3,3]).draw()
grestore()
...
drawvector(Tu)
Label(r"$T(S(R({\boldsymbol x})))$", Tu, alignment="rt", offset=[-3,-5]).draw()
grestore()
