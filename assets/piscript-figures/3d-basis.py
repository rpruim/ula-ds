...
Label(r"${\boldsymbol e}_1$", tofig([x0,0,0]), alignment="lc", offset=[4,-4]).draw()
Label(r"${\boldsymbol e}_2$", tofig([0,y0,0]), alignment="rb", offset=[4,4]).draw()
Label(r"${\boldsymbol e}_3$", tofig([0,0,z0]), alignment="lc", offset=[4,2]).draw()
